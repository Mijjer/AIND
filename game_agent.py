        ...
        **********************************************************************
        ...
        def min_value(game, depth):
            ...
            for move in game.get_legal_moves():
                min_val = min(min_val, max_value(game.forecast_move(move), depth - 1))
            return min_val
        ...
        def max_value(game, depth):
            ...
            max_val = float("-inf")
            for move in game.get_legal_moves():
                max_val = max(max_val, min_value(game.forecast_move(move), depth - 1))
            return max_val
        ...
        if not legal_moves:
            ...
            best_move = legal_moves[0]    
        for move in game.get_legal_moves():
            min_val = min_value(game.forecast_move(move), depth - 1)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        # TODO: finish this function! So far only copy of above method
        ...
        try:
            ...
            #implement iterative deepening search (for loop) 
            self.search_depth = 2
            while True:
